...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <!-- Display success message after successful sign-up -->
            <c:if test="${param.signup == 'success'}">
                <div class="alert alert-success">Sign up successful. Please login.</div>
            </c:if>
            <!-- Display error message if sign-up passwords don't match -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="signupModalLabel">Customer Sign Up</h5>
